...
public class OVRLint : EditorWindow
{
	...
	static void CheckStaticCommonIssues ()
	{
		...
		//if ((!PlayerSettings.MTRendering || !PlayerSettings.GetMobileMTRendering(BuildTargetGroup.Standalone)))
		//{
		...
		//    {
		//		PlayerSettings.MTRendering = PlayerSettings.SetMobileMTRendering(bui = true;
		//	}, null, "Fix");
		//}
